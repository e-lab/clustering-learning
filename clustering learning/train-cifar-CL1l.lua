...
----------------------------------------------------------------------
-- note: 1024 filter out of memory on 16GB laptop!!! careful
...
--trainData2.data = l1net:forward(trainData.data)
for t = 1,testData:size() do
   testData2.data[t] = l1net:forward(testData.data[t]:double())
   xlua.progress(t, testData:size())
end
--testData2.data = l1net:forward(testData.data)
...
-- show a few outputs:
--image.display{image=trainData2.data[{{1,256}}]:reshape(256,64,24,24)[{{1,256},{1}}]:reshape(256,24,24), nrow=16, padding=2, zoom=2, legend='Processed dataset output'}
