...
-- load neural net for finding features to track:
networkfile = '/Users/eugenioculurciello/AdvancedResearch/SyntheticVision/torch7-demos/face-detector/face.net'
network = nn.Sequential()
network = torch.load(networkfile):float()
network_fov = 32
network_sub = 4
...
function process()
	...
	processed = network:forward(Ninputim[1]) -- goes throught convnet to find points of interests
