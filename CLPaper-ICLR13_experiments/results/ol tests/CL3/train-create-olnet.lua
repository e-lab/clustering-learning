...
cmd:option('-nkernels1', 128 , 'number of kernels 1st layer') -- OL: 16
cmd:option('-nkernels2', 32, 'number of kernels 2nd layer') -- OL: 128
cmd:option('-nkernels3', 32, 'number of kernels 3rd layer') -- OL: 128
