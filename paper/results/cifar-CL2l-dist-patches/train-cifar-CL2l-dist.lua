...
-- use random patches as filters
kernels = data[{{1,nk}}]

image.display{image=kernels, padding=2, zoom=2, nrow=math.floor(math.sqrt(nk)), legend='2nd layer filters'}
...
l1net.modules[4].weight = torch.ones(1)*(1/is)*(1/is)*(1/2) -- the value 2/is is empirical, looking at net output...
