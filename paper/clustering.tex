...
\cite{Socher2012}	&? 		&80.8\%, RGB-D	&128		&ZCA \\
\cite{Coates2011b}	&?		&82\%, CIFAR10	&1600		&ZCA \\
\cite{Krizhevsky2012} &?		&98.5\% ImageNet	&96			&none\\
\cite{Ciresan2012}	&?		&88.8\%, CIFAR10	&300		&none\\
\cite{jarrett-iccv-09}	&?		&99.5\%, MNIST	&32			&none\\
\hline\hline
\end{tabular}
\end{center}
\label{table2}
