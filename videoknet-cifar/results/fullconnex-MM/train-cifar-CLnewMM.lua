...
if opt.display then image.display{image=kernels1_:reshape(nk1,ivch,is,is), padding=2, symmetric=true, zoom=4, legend = 'Layer 1 filters'} end
...
if opt.display then image.display{image=kernels2_:reshape(nk2,nk1,is,is)[{{},{1}}], padding=2, symmetric=true, zoom=4, legend = 'Layer 2 filters'} end
