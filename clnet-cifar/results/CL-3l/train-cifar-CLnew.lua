...
trainDataF.data = trainDataF.data:reshape(trsize, nk3, l1netoutsize, l1netoutsize)
testDataF.data = testDataF.data:reshape(tesize, nk3, l1netoutsize, l1netoutsize)
