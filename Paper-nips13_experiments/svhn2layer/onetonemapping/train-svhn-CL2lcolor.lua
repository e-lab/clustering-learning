...
is = 5
fanin = 1 -- createCoCnxTable creates also 2*fanin connections 
...
cTable2, kernels2 = createCoCnx(nlayer, trainData2, nk1, feat_group, fanin, 10*opt.nsamples, nnf2, is, kernels1, false)
print(cTable2)
nk2 = cTable2:max()
nk = nk2
...
vnet2.modules[1].weight = kernels2:reshape(kernels2:size(1),is,is)  
