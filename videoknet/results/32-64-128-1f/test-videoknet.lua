...
datamul = 2 -- scale images in dataset by 2x or not?
nk = nk3
...
for t = 1,trainsize do
   temp = image.scale(trainData[t][1], in_sz, in_sz) -- process on 2x scaled dataset
...
for t = 1,testsize do
   temp = image.scale(testData[t][1], in_sz, in_sz) -- process on 2x scaled dataset
