...
kernels1 = trainLayer(nlayer, trainData, opt.nsamples, nil, nk1, nnf1, is) -- with slac
-- kernels1, connTable1 = slac(kernels1, startN, finalN,tau,Delta) -- SLAC algorithm to aggregate kernels
kernels1s, connTable1 = slac(kernels1, nk1, nk1/2, 5, 4.2) -- SLAC algorithm to aggregate kernels
...
kernels1s:div(nnf1*nk1*ivch) -- divide kernels so output of SpatialConv is about ~1 or more
...
-- SLAC: nk1*4 filters to learn, then narrow down to nk1:
kernels2 = trainLayer(nlayer, trainData2, opt.nsamples*10, nil, nk2, nnf2, is) -- with slac
kernels2s, connTable2 = slac(kernels2, nk2, nk2/2, 5, 4.5) -- SLAC algorithm to aggregate kernels
...
vnet2:add(nn.SpatialConvolution(nk1, nk2s, is, is,cvstepsize,cvstepsize)) -- fully connected
...
kernels2s:div(nk2) -- divide kernels so output of SpatialConv is about ~1 or more
