...
-- SLAC: nk1*4 filters to learn, then narrow down to nk1:
--kernels2 = trainLayer(nlayer, trainData2, opt.nsamples*10, nil, nk2*nk1, nnf2, is) -- with slac
...
vnet2:add(nn.SpatialConvolution(nk1, nk2, is, is,cvstepsize,cvstepsize)) -- fully connected --SLAC with nk2s
