...
As stated in the Table \ref{tab:cifar} and \ref{tab:svhn}, 1 layer (32 filters) gives $68.8\%$ on CIFAR-10 dataset and $85.7\%$ on SVHN dataset.
...
Since the random connection of the features gave the best results on CIFAR-10 and SVHN as stated in the Tables \ref{tab:cifar} and \ref{tab:svhn},
