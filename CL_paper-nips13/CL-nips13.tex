...
As stated in the Table \ref{tab:results-cifar10} and \ref{tab:results-svhn}, 1 layer (32 filters) gives $68.8\%$ on CIFAR-10 dataset and $85.7\%$ on SVHN dataset.
...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.5\textwidth}
                ...
                \caption{Filters with full connection.}
        \end{subfigure}%
        ~%add desired spacing between images, e. g. ~, \quad, \qquad etc. 
          %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[b]{0.5\textwidth}
                ...
                \caption{Filters with fan-in of 2 random connection.}
        \end{subfigure}
        \caption{Second layer filters from CL for comparison.}
\end{figure}
...
Since the random connection of the features gave the best results on CIFAR-10 and SVHN as stated in the Tables \ref{tab:results-cifar10} and \ref{tab:results-svhn},
we tested how many features to be combined for the best accuracy.
