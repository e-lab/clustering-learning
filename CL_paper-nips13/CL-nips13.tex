...
The fully connected RF use filters obtained by CL across all 32 input feature maps. This architecture suffers from the curse of dimensionality because of the large 32 $\cdot$ 5 $\cdot$ 5 high-dimensional feature space, and clustering learning is not able to find selective RF and groups.
